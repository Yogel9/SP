...
namespace SPDovidenkov
{
    public partial class Form1 : Form
    {
        ...
        [DllImport("MFCLibrary.dll")] static extern int dllWaitConfirm();

        [DllImport("MFCLibrary.dll")] public static extern void dllConnectToServer();
